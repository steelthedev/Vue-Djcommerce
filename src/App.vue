    ...
    <nav class="navbar nav-bar navbar-expand-md  navbar-dark  fixed-top" id="nav">
      ...
      <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                ...
                <span>Cart ({{ cartTotalLength }})</span>
                    ...
                    <li class="nav-item">
                       <router-link to="/" class="nav-link" >Winter</router-link> 
                    </li>

                    <li class="nav-item">
                       <router-link to="/" class="nav-link" >Summer</router-link> 
                    </li>
                         <form class="d-flex" action="/search" method="get">
              <input class="form-control me-2" type="search" name="query"  placeholder="Search" aria-label="Search" >
              <button class="btn btn-outline-white btn-success" type="submit">Search</button>
              </form>
        </ul>
      </div>
    </div>	
